...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :class="{
            'author-item': true,
            'author-highlight': author.name === 'George Orwell'
          }"
        >
    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          v-for="(count, type) in bookstores.storeTypes"
          :key="type"
        >
          {{ type }} — {{ count }} stores
        </li>
      ...
      <ul>
        <li
          v-for="(hours, label) in bookstores.openingHours"
          :key="label"
        >
      ...
      <ul>
        <li
          v-for="country in bookstores.countries"
          :key="country"
        >
          {{ country }}
        </li>
